...
class CompTransTTS(nn.Module):
    ...
    def __init__(self, preprocess_config, model_config, train_config):
        ...
        self.speaker_emb = self.emotion_emb = self.intensity_emb =None
        ...
        if model_config["multi_intensity"]:
            with open(
                os.path.join(
                ...
                # print(f'n_intensity : {n_intensity}')
    ...
    def forward(
        ...
        # print(f'context_encodings : {context_encodings}')
        ...
        intensity_embeds = None
        if self.intensity_emb is not None:
            intensity_embeds = self.intensity_emb(intensities)
